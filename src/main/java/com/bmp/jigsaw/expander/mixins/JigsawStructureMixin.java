...
public abstract class JigsawStructureMixin {
    ...
    private static DataResult<JigsawStructure> verifyRange(JigsawStructure jigsawStructure) {
        ...
        return ((JigsawStructureAccessor)(Object)jigsawStructure).getMaxDistanceFromCenter() + i > MAX_TOTAL_STRUCTURE_RANGE
                ? DataResult.error(() -> "Structure size including terrain adaptation must not exceed 512")
    ...
    public static final MapCodec<JigsawStructure> CODEC = RecordCodecBuilder.<JigsawStructure>mapCodec(
        ...
        .validate(JigsawStructureMixin::verifyRange);
}
